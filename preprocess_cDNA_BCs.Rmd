...
# Load in Kevin Lin's functions for barcode assignment
```{r, include=FALSE}
...
# Do barcode assignment for all_data
```{r, include=FALSE}
...
# Remove lineages with posterior < 0.5
all_data$assigned_lineage_unfilt <- all_data$assigned_lineage
all_data$assigned_lineage[all_data$assigned_posterior < 0.5] <- NA


save(all_data, file = 'preprocess_cDNA_BCs/all_data_lineages.RData') # all other samples will be subset from this whenever needed
```
